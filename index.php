...
// ========== إعدادات الموقع ==========
$site_title = "معرض الرسومات الشخصية - سر التعاون";
$colors = [
    'primary' => '#2c3e50',
    'secondary' => '#d4af37', 
    'accent' => '#34495e',
...
if (isset($_POST['admin_login'])) {
    ...
    // ⚠️ تغيير هذه المعلومات قبل النشر!
...
<body>
    <header class="main-header">
        <h1>سر التعاون</h1>
        <div class="subtitle">معرض الرسومات الشخصية لمشروع التخرج</div>
        <div class="graduation-badge">🎓 Class of 2025</div>
    </header>
        ...
        <?php if ($current_view === 'home'): ?>
            ...
            <div class="card">
                <h2 style="text-align: center; color: var(--primary); margin-bottom: 2rem; font-size: 2rem;">
                    أهلاً وسهلاً في معرض سر التعاون! 🎨
                </h2>
